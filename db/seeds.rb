...
Order.create(user_id: 3, status: "ordered", pickup_or_delivery: "pickup",   line_items: {"2" => "17"}, address: 2)
...
Order.create(user_id: 3, status: "completed", pickup_or_delivery: "pickup",   line_items: {"11" => "10"}, address: 2)
